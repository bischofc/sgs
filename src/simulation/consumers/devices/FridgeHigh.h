...
#ifndef simulation_endpoint_consumer_fridgeHigh_h
#define simulation_endpoint_consumer_fridgeHigh_h
...
class FridgeHigh : public Consumer {

public:
  FridgeHigh(std::string consumerId) : Consumer(consumerId, 170) {
