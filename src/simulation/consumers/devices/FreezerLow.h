...
#ifndef simulation_endpoint_consumer_freezerLow_h
#define simulation_endpoint_consumer_freezerLow_h
...
class FreezerLow : public Consumer {

public:
  FreezerLow(std::string consumerId) : Consumer(consumerId, 90) {
