...
public:
  BoilerHigh(std::string consumerId) : Consumer(consumerId, 2000) {
    ...
    addEnergyPlan(boost::shared_ptr<config::EnergyPlan>(new config::EnergyPlanInfinitePeriod("BoilerHigh", period, duration, 0, connectedLoad, highTimeVariation)));
  }
