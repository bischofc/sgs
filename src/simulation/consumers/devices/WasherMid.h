...
class WasherMid : public Consumer {
 ...
 public:
  WasherMid(std::string consumerId) : Consumer(consumerId, 450) {
    ...
    addEnergyPlan(boost::shared_ptr<config::EnergyPlan>(new config::EnergyPlanSelective("WasherMid", day, ttype, start, duration, connectedLoad, startVariation, durationVariation, true)));
